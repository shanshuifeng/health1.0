...
public class CheckGroupDialog extends JDialog {
    ...
    private void initializeUI() {
        ...
        // 添加表单字段
        addFormField(formPanel, "名称:", nameField = new JTextField(checkItemGroup.getName()));
        addFormField(formPanel, "描述:", descriptionField = new JTextField(checkItemGroup.getDescription()));
        addFormField(formPanel, "价格:", priceField = new JTextField(checkItemGroup.getPrice() != null ? checkItemGroup.getPrice().toString() : ""));
